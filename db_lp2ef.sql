CREATE DATABASE  IF NOT EXISTS `db_lp2ef` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_lp2ef`;
...
INSERT INTO `role` VALUES (1,'SuperAdmin','Administrador'),(2,'Sudo','Adminitrador 2?');
...
SELECT *
FROM user
WHERE user.registro >= DATE_SUB(CURRENT_DATE, INTERVAL 6 MONTH);